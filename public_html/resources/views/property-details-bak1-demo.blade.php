...
@section('content')
  @component('components.page-title')
    @slot('title', 'Stunning 6 Bed House for sale')
    {{-- @slot('subtitle', 'Reference #: RC-12345') --}}
  @endcomponent

  <div class="container mb-2x">
    <div class="row">
      <div class="col-md-8">
        <!-- #preview-image -->
        <div id="preview-image" class="bg-wrapper h-420px">
          <div class="bg-image">
            <a href="#">
              <img src="http://placehold.it/100px420" width="100%" alt="">
            </a>
          </div>
        </div>
        <!-- /#preview-image -->
        ...
        <div id="description" class="mb-1x">
          <p>This 7 bed villa that has recently come onto the market is up for sale and an incredibly attractive price. Situated close to the Phoenix Golf Course, the location is perfect for those who love a game of golf as well as those who need to be in a central location that has access to Bangkok, Raying and Pattaya.</p>

          <p>This 7 bed villa is sited on a large land plot of 1,600sqm, and has a massive 900 sqm of living area. This wonderful house is perfect for larger families and for those who enjoy entertaining friends and family. If you are looking for a spacious, luxury home that has plenty of space, is well designed and built to last, then you need to watch the video below.</p>
        </div>
        <!-- /#description -->

        <h3 class="bold text-uppercase mb-2">Watch The Video</h3>
        <!-- #gallery-video -->
        <div id="gallery-video" class="mb-2x bg-gray-800 box-shadow">
          <div class="embed-responsive embed-responsive-16by9">
            <iframe class="embed-responsive-item" src="https://www.youtube.com/embed/26zhz0_TRho?rel=0&amp;showinfo=0" allowfullscreen></iframe>
          </div>
        </div>
        <!-- /#gallery-video -->
