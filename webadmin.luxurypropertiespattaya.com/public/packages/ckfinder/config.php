...
ATTENTION: The trailing slash is required.
*/
$baseDir = rtrim(realpath(__DIR__ . '/../../../public/uploads/'), '/') . '/';
// $baseDir = '/home/lpp/webadmin.luxurypropertiespattaya.com/public/uploads/';
// $baseDir = resolveUrl($baseUrl);
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => 0,
		'allowedExtensions' => 'avi,bmp,csv,doc,docx,gif,gz,gzip,jpeg,jpg,mov,mp3,mp4,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,pxd,qt,ram,rar,rm,rmi,rmvb,rtf,sdc,sitd,sxc,sxw,tar,tgz,txt,wav,wma,wmv,xls,xlsx,zip',
...
$config['plugin_imageresize']['mediumThumb'] = '240x240';
$config['plugin_imageresize']['largeThumb'] = '320x320';
