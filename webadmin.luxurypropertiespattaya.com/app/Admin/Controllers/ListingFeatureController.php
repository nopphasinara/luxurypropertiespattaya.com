...
class ListingFeatureController extends BaseController
{
    use ModelForm;
    ...
    public function index()
    {
        return Admin::content(function (Content $content) {
            ...
            $content->header('Listing Features');
    ...
    {
        return Admin::grid(ListingFeature::class, function (Grid $grid) {
    ...
    {
        return Admin::form(ListingFeature::class, function (Form $form) {
