...
class DirectoryAdsController extends BaseController
{
    use ModelForm;
    ...
    public function edit($id)
    {
        return Admin::content(function (Content $content) use ($id) {
            ...
            $this->model = DirectoryAds::where('id', $id)->first();
    ...
    {
        return Admin::grid(DirectoryAds::class, function (Grid $grid) {
            ...
            $grid->column('search_visible', 'Search Page Visible')->switch($states);
    ...
    {
        return Admin::form(DirectoryAds::class, function (Form $form) {
            ...
            $form->text('url', 'URL')->rules(function ($form) {
              $rules = 'nullable';
            ...
            $form->switch('search_visible', 'Search Page Visible')->default(0);
