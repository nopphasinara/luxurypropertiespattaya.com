...
class DirectoryController extends BaseController
{
    ...
    {
        return Admin::grid(Directory::class, function (Grid $grid) {
    ...
    {
        return Admin::form(Directory::class, function (Form $form) {
            ...
            $form->text('email', 'Email Address')->attribute([
              'type' => 'email',
            ])->rules('required');
            $form->text('phone', 'Phone No.')->attribute([
              'type' => 'tel',
            ])->rules('required');
            $form->text('website', 'Website')->attribute([
              'type' => 'url',
            ])->rules('required');
            ...
            // Add textarea for the describe field
            $form->image('image', 'Logo Image')->move('directory')->uniqueName()->removable();
